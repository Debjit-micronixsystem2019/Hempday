...
class TakeQuizVC: UIViewController {
    ...
    extension TakeQuizVC : UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout{
        ...
        func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
            ...
            if quiezes?.question == "HEALTH CONCERNS (SELECT ALL APPLY)" || quiezes?.question == "WHAT ARE YOUR TASTE BUDS FEELING  "{
       ...
       func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        ...
        var collectionViewHeightDynamically = CGFloat()
         let quiezes = self.QuizArray?[showIndex]
        if view.frame.size.height > 812 && quiezes?.option_count == 3{
         //   if  choiceAnswer?.count == 3{
            topConstant.constant = 140.0
            bottomConstant.constant = 80.0
            collectionViewHeightDynamically = 360.0
            print("choiceAnswer?.count")
           // }
        }else{
            topConstant.constant = 100.0
            bottomConstant.constant = 40.0
            collectionViewHeightDynamically = 280.0
            
            print("choiceAnswer?.count",choiceAnswer?.count)
        }
